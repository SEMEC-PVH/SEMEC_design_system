...
export const navigation = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/componentes/acoes-e-links", label: "Ações e links" },
      { href: "/componentes/botoes", label: "Botões", sub: true },
      { href: "/componentes/botao-de-icone", label: "Botão de ícone", sub: true },
      { href: "/componentes/link", label: "Link", sub: true },
      { href: "/componentes/formularios", label: "Formulários" },
      { href: "/componentes/caixa-de-texto", label: "Caixa de texto", sub: true },
      { href: "/componentes/area-de-texto", label: "Área de texto", sub: true },
      { href: "/componentes/menu-de-selecao", label: "Menu de seleção", sub: true },
      { href: "/componentes/combobox", label: "Combobox", sub: true },
      { href: "/componentes/seletor-de-data", label: "Seletor de data", sub: true },
      { href: "/componentes/envio-de-arquivos", label: "Envio de arquivos", sub: true },
      { href: "/componentes/caixa-de-marcacao", label: "Caixa de marcação", sub: true },
      { href: "/componentes/botao-de-opcao", label: "Botão de opção", sub: true },
      { href: "/componentes/interruptor", label: "Interruptor", sub: true },
      { href: "/componentes/rotulo", label: "Rótulo", sub: true },
      { href: "/componentes/campo-de-formulario", label: "Campo de formulário", sub: true },
      { href: "/componentes/conteudo-e-dados", label: "Conteúdo e dados" },
      { href: "/componentes/cartao", label: "Cartão", sub: true },
      { href: "/componentes/etiqueta", label: "Etiqueta", sub: true },
      { href: "/componentes/tabela", label: "Tabela", sub: true },
      { href: "/componentes/navegacao", label: "Navegação" },
      { href: "/componentes/trilha-de-navegacao", label: "Trilha de navegação", sub: true },
      { href: "/componentes/abas", label: "Abas", sub: true },
      { href: "/componentes/paginacao", label: "Paginação", sub: true },
      { href: "/componentes/feedback-e-estados", label: "Feedback e estados" },
      { href: "/componentes/aviso", label: "Aviso", sub: true },
      { href: "/componentes/notificacao", label: "Notificação", sub: true },
      { href: "/componentes/modal", label: "Modal", sub: true },
      { href: "/componentes/dica", label: "Dica", sub: true },
      { href: "/componentes/esqueleto", label: "Esqueleto", sub: true },
      { href: "/componentes/estado-vazio", label: "Estado vazio", sub: true },
