...
export const dsCategories = [
  {
    ...
    slug: "formulario",
    label: "Formulário",
    desc: "Campos, controles de escolha e ações de preenchimento.",
  },
  {
    key: "layout-dados",
    slug: "layout-e-dados",
    label: "Layout e dados",
    desc: "Superfícies de conteúdo, sinalização e exibição de dados.",
  },
  {
    key: "navegacao",
    slug: "navegacao",
  ...
  },
  {
    ...
    slug: "overlay-feedback",
    label: "Overlay e feedback",
    desc: "Camadas sobre a página e mensagens de estado.",
  },
];
