...
export const tableAdvancedUsage = `import { Table, TableHeader, TableRow, TableHead, TableBody, TableCell, Badge, Checkbox, Input, Select, Pagination, EmptyState, Skeleton } from "@semec/base";
