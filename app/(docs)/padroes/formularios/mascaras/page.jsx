...
export default function MascarasPage() {
  return (
    <>
      ...
      <CodeBlock code={formAdvancedUsage} filename="FormAdvanced.jsx" prompt="Crie campos com máscara CPF CNPJ CEP moeda usando @semec/base — Input com inputMode numeric e formatação ao digitar" />
    </>
  );
}
