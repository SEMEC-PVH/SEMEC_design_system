...
export default function MensagensDeErroPage() {
  return (
    <>
      ...
      <CodeBlock code={formAdvancedUsage} filename="FormAdvanced.jsx" prompt="Crie mensagens de erro acessíveis com ErrorSummary e FormField aria-invalid usando @semec/base" />
    </>
  );
}
