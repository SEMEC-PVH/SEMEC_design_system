...
export default function TabelasPage() {
  return (
    <>
      ...
      <CodeBlock code={tableAdvancedUsage} filename="TableAdvanced.jsx" prompt="Crie Tabela avançada com ordenação, filtros, paginação, seleção, EmptyState e Skeleton usando @semec/base" />
    </>
  );
}