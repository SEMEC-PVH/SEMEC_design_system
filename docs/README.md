...
| [adr/](adr/README.md) | **Registro histórico.** Dezesseis decisões arquiteturais, uma por arquivo, com contexto, alternativas descartadas e consequências. Não são reescritos: decisão nova entra como ADR novo. | Ao descobrir que uma decisão já foi tomada, ou antes de tomar uma que a contrarie. |
